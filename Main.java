        ...
        submitButton.addActionListener(e -> {
            ...
            try {
                ...
                while (true) {
                    ...
                    if ((Eagles + Giants) > 100) {
                        System.out.println("No more than 100");
                        String eagleDensity2 = eaglesField.getText();
                        String giantsDensity2 = giantsField.getText();

                        Eagles = Integer.parseInt(eagleDensity2);
                        Giants = Integer.parseInt(giantsDensity2);
                    } else {
                        break;
                    }
                }
